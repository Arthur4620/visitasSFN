...
<ul>
  <a href="mapa.php"><li><span class="icon-map"></span>  Mapa</li></a>
  <li data-toggle="modal" data-target="#exampleModal"><span class="icon-office"></span> Agregar Clínica</li>
 <!-- <li data-toggle="modal" data-target="#exampleModal3"><span class="icon-office"></span> Clínicas </li>
  <li data-toggle="modal" data-target="#exampleModal2"><span class="icon-lab"></span>   <span class="icon-user-plus"></span>   Laboratorios</li>
  ...
  -->
  <a href="../visita.php"><li data-toggle="modal" data-target=""><span class="icon-pencil2"> Visita </li></a>
  <a href="../logout.php"><li> <span class="icon-exit"></span> Salir</li></a>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <?php
        ...
        <br><br>
            ...
            <input type="hidden" class="form-control form-control-sm" id="actual" name="actual" >
           </div>
            ...
            <label for="nombreNewU">Observaciones:</label>
            <br>
